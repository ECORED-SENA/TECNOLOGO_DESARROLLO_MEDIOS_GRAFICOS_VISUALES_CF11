...
.banner-principal
  .container.tarjeta.position-relative(
    ...
    .imagen_flotante_2: img(src="@/assets/curso/float3.png")
    .imagen_flotante_3.d-none.d-xl-block: img(src="@/assets/curso/float5.png")
    .imagen_flotante_4: img(src="@/assets/curso/float2.png")
    .imagen_flotante_5: img(src="@/assets/curso/float1.png")
